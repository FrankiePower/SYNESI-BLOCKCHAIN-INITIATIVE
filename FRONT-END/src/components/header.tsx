...
const Header = () => {
  return (
    ...
    <nav className="hidden md:flex space-x-4">
      ...
      <Link href="/verification" className="text-gray-600 hover:text-primary-blue">Verification</Link>
      <Link href="/courses" className="text-gray-600 hover:text-primary-blue">Courses</Link>
